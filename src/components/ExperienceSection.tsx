        ...
        <div className="relative border-l border-zinc-800 ml-4 sm:ml-8 space-y-8 pl-6 sm:pl-10">
          {EXPERIENCE_DATA.map((exp, idx) => (
            <div key={exp.id} className="relative group">
              ...
              <div className="absolute -left-[30px] sm:-left-[52px] top-1.5 w-6 h-6 rounded-full bg-zinc-950 border-2 border-emerald-500/60 group-hover:border-emerald-400 group-hover:scale-125 transition-all duration-300 flex items-center justify-center shadow-lg shadow-emerald-500/20">
